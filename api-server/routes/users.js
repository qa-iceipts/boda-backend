...
router.post(
  "/addUser",
  PromiseHandler(userService.addUser),
  PromiseHandler(userService.login)
);
...
router.post("/backendLogin/:roleName", PromiseHandler(userService.login));

router.get(
  "/getUser/:id",
  authorize(),
  PromiseHandler(userService.getUserById)
);

router.put(
  "/updateUser/:userId",
  authorize(),
  PromiseHandler(userService.updateUser)
);

router.patch(
  "/patchUser/:userId",
  authorize(),
  PromiseHandler(userService.patchUser)
);
...
router.put(
  ...
  PromiseHandler(userService.disableUser)
);
...
router.get(
  ...
  authorize(),
  PromiseHandler(userService.getAllUsers)
);
...
router.get(
  "/getDriverProfile/:id",
  PromiseHandler(userService.getDriverProfile)
);

//send custom Notifications to any user api
router.post(
  "/sendNotification/:userId",
  PromiseHandler(userService.sendNotification)
);
