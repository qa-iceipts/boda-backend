...
const { addDNSConnection } = require('../services/dnsConnections.service')
...
exports = module.exports = function (io) {
    ...
    io.on('connection', async function (socket) {
        ...
        socket.emit("onconnect", { msg: "welcome User", socketId: socket.id });

        socket.on('getAvailableRides', async function (data) {
            ...
            socket.on('getOffers', async function (data) {
                console.log("getOffers event called", data);
                let [result, driverIds] = await fetchDrivers(data)
